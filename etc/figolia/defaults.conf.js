...
var CONFIG = {
    ...
    firebase: {
        instance: process.env.FIREBASE_INSTANCE || 'whatsgood-f1e9b',
        secret: process.env.FIREBASE_SECRET || 'prECtY7aFMzZdoZbYSif2Bbr4bvGDS2FjX8x6xLK',
    ...
    // Algolia credentials
    algolia: {
        applicationId: process.env.ALGOLIA_APP_ID || '2OEMW8KEZS',
        // *Admin* API Key
        apiKey: process.env.ALGOLIA_API_KEY || 'eda259be0c749313ac33e0d07e465443'
    },
