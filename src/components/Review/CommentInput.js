  ...
  constructor() {
    ...
    this.createComment = ev => {
      ...
      if (this.state.body !== '') {
        ...
        this.setState({ body: '' });
        this.props.onThreadCommentSubmit(this.props.authenticated, this.props.userInfo, this.props.type, this.props.commentObject, commentBody, this.props.threadId);
      }
    };
  }
