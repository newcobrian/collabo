...
class VerifyEmail extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.sendMixpanelEvent(Constants.MIXPANEL_PAGE_VIEWED, { 'page name' : 'verify email page'});
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.params.vid !== this.props.params.vid) {
